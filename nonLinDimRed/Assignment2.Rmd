...
Above the non-parametric density estimation of lambda in each cluster is plotted by itself.
...
The density plots shows that in cluster one lambdas are lowest, followed by cluster 4, cluster 2, and finally cluster 3. 
