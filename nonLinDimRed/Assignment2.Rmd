...
i=dfValue
# print(i) # just for testing, working on syntax
...
# print(err) # just for testing, working on syntax 
errVect[i-1] <- err

}
plot(dfValues, errVect,xlab="df", ylab="Error")

smallestValueIndex <- which.min(errVect)
smallestValue <- errVect[smallestValueIndex]
correspondingDfValue <- dfValues[smallestValueIndex]
...
# TODO: Compare to the resukt in a) and discuss.