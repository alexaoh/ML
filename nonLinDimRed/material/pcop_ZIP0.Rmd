...
n<-1190 # The application PCOP.exe does not run with all the n=1194 data of dim 4
prcv.0 <- pcop(x=zip.0.PC$scores[1:n,1:4],Ch=1.5,Cd=.3,plot.true=TRUE,col=2,lwd=4)
#names(prcv.0)
#[1] "pcop.f1" "pcop.f2"
...
prcv.0.HSPC <- principal_curve(zip.0.PC$scores[1:1190,1:4])
#names(prcv.0.HSPC)
