...
2. Performing a metric MDS of the data, using the `cmdscale` program. 
...
3. Calcualting the goodness-of-fit (in percentage) of the three-dimensional solution:
...
10. Give an *interpretation* to each of the first 3 dimensions and compare them to those obtained by metric scaling. 
...
12. Make a scatterplot matrix of the first three dimensions of the metric MDS solution and 
